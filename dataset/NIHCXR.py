...
def preprocess():
    ...
    meta_data = pd.read_csv("/data/pycode/CXRAD/dataset/Data_Entry_2017_v2020.csv" , sep=',') #detailed information of images
    ...
    train_val_list_path = "/data/pycode/CXRAD/dataset/train_val_list.txt" 
    test_list_path = "/data/pycode/CXRAD/dataset/test_list.txt" 
